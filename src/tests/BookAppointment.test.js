...
describe('testing BookAppointment',() =>{
    ...
    it('renders a name appdate',() => {
    	expect(shallow(<BookAppointment/>).find('#date').length).toEqual(1);
    })
    ...
    it('should change the appdate state of adding patient',() => {
    	wrapper.find('#date').simulate('change',{target: {name: 'date',value:'26/05/2019'}});
    	expect(wrapper.state('date')).toEqual('26/05/2019');
    })
